...
export default {
  ...
  async fetch(entry, ctx) {
    ...
    // upstream: timeout + backoff/jitter retry to dodge Ashby's latency floor + rate-limiting.
    // ours: capture the publishedAt posting date for freshness sorting/--max-age-days.
    let lastErr;
